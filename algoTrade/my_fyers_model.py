...
class MyFyersModel(object):
    ...
    # Order Placement
    def punch_place_order(self, data):
        """
        Single Order
    ...
    def punch_place_basket_orders(self, data):
        """
        Multi Order
    ...
    def get_option_chain(self, data):
        ...
        Out-of-The-Money (OTM) strikes: Strike prices higher than the current market price for Calls (CE) and lower than the current market price for Puts (PE).
        The API will return data for 2 CE and 2 PE OTM strikes.

        In-The-Money (ITM) strikes: Strike prices lower than the current market price for Calls (CE) and higher than the current market price for Puts (PE).
        The API will return data for 2 CE and 2 PE ITM strikes.
