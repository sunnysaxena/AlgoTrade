...
logging.basicConfig(
    filename="trading_script_5min.log",
    level=logging.DEBUG,
...
# Get latest data from 9:30 to thesymbol next hours
def get_latest_data():
    global ohlc_df
    try:
        latest_df = fyers_utility.get_todays_data(symbol=OPTION_SYMBOLS_FYERS['nifty50'], time_interval='5')
